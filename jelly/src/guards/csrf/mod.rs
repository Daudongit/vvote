// https://raw.githubusercontent.com/edward-shen/actix-csrf/master/src/lib.rs
#![deny(unsafe_code)]
...
impl ResponseError for CsrfError {
    fn error_response(&self) -> HttpResponse {
        ...
        HttpResponse::InternalServerError().body(render(self))
    }
}
...
#[cfg(test)]
mod tests {
    use super::extractor::{Csrf, CsrfHeader};
